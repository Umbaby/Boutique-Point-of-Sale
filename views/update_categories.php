...
?>
    <div class="container">
        <form action="<?php $_PHP_SELF; ?>" method="POST">
            <fieldset>
                <legend><p class="head">Update Category</p></legend>
                    ...
                    <label for="category_name">Category Name</label><br>
                        <input type="text" name="category_name" value="<?php echo $row['1']; ?>"/><br><br>

                        <input type="submit" name="submit2" value="Update Category">
            </fieldset>
        </form>
    </div>
