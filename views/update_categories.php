<?php session_start();
    include "../controllers/update_categories_function.php"; 
      ...
      <section class="wrapper">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="update_categories.php"> <i class="fa fa-plus"></i> Change Category Name</a></li>        
          </ol>
        </div>
      </div>
    ...
    <div class="container">
        <form action="<?php $_PHP_SELF; ?>" method="POST">
                    <label for="category_name">Category Name</label><br>
                        <input type="text" name="category_name" class="category_name" required />
...
?>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td><input type="number" name="category_number" value="<?php echo $row['0']; ?>" readonly/></td>
                                <td><input type="text" name="category_name" value="<?php echo $row['1']; ?>" required/></td>
                            </tr>
                        </tbody>
                    </table>

                    <input type="submit" name="submit2" value="Change">
                    <a href="update_categories.php">Cancel</a>
