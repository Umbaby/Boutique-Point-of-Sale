...
<html>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_genius"></i> Inventory</h3>
            <ol class="breadcrumb">
              <li><i class="icon_genius"></i><a href="view_products.php">Inventory</a></li>
              <li><a href="view_products.php"> <i class="fa fa-list"></i> List of Products</a></li>        
            </ol>
          </div>
        </div>
		<div class="row">
	...
	<div class="container">
		...
		?>
			...
			<?php
					...
					$category_query = "SELECT * FROM products WHERE category ='$category' ORDER BY product_name ASC";
				...
				?>
					...
					<tbody>
						<?php while($category_row=$category_result->fetch_array()){ ?>
							<tr>
								<td><?php echo $category_row['0']; ?></td>
								<td><?php echo $category_row['2']; ?></td>
								<td>
								<?php 
								...
								<td><?php echo "Php ".$category_row['5']; ?></td>
								<td><?php if($category_row['4']>0){ echo $category_row['4'];} else { echo "Out of stock";} ?></td>
								<td><?php echo $category_row['3']; ?></td>
								<td><?php echo $category_row['6']; ?></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
      <?php	} else { ?>
          ...
          <?php echo "<h4>No products in this category yet.</h4>";
                }
                }
                } ?> 
