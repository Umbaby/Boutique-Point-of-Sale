...
<html>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_genius"></i> About The Developers</h3>
            <ol class="breadcrumb">
              <li><i class="icon_genius"></i><a href="developers.php">Developers</a></li>
              <li><a href="developers.php"> <i class="fa fa-list"></i>Personal Informations</a></li>        
            </ol>
          </div>
        </div>
		<div class="row">
