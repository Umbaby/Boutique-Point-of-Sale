        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="delete_from_cart.php"> <i class="fa fa-plus"></i> Remove Product from Cart</a></li>        
            </ol>
          </div>
        </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="quantity" size="20" value="<?php echo $row['4']; ?>" readonly/></td>
                                </tr>
                        </tbody>
			        </table>
