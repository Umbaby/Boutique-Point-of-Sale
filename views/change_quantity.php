        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="update_products.php"> <i class="fa fa-plus"></i> Change Product Quantity</a></li>        
            </ol>
          </div>
        </div>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="product_name" size="20" value="<?php echo $row['1']; ?>" readonly/></td>
                                    <td><input type="text" name="product_price" size="20" value="<?php echo $row['2']; ?>" readonly/></td>
                                    <td><input type="text" name="description" size="20" value="<?php echo $row['3']; ?>" readonly/></td>
                                    <td><input type="number" name="quantity" min="1" max="<?php echo $stock_row['0']; ?>" value="<?php echo $row['4']; ?>" required/></td>
                                </tr>
                        </tbody>
			        </table>
                    ...
                    <a href="view_cart.php">Cancel</a>
                        ...
                        <?php 
                         ...
                         echo "<h3>No such product exists.</h3><br>";   
                        }
                    }
                 } else {
                     echo "<h3>No products added to the cart yet.</h3><br>";
                 } ?>
    </div>
