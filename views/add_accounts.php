      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-uers"></i><a href="views_accounts.php">Accounts</a></li>
              <li><a href="add_accounts.php"> <i class="fa fa-plus"></i> Add New Account</a></li>        
            </ol>
          </div>
        </div>
            ...
            <section class="panel">        
                ...
                <form action="<?php $_PHP_SELF; ?>" method="POST">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                      <tr>
                                          <td><input type="text" name="name" size="12" required/></td>
                                          <td><input type="number" name="age" min="18" max="65" required/></td>
                                          <td><input type="number" name="mobile" minlength="11" maxlength="11" required/></td>
                                          ...
                                          <td><input type="password" name="password" size="12" minlength="8" required/></td>
                                          <td><input type="password" name="confirm" size="12" minlength="8" required/></td>
                                      </tr>
                                </tbody>
                            </table>
                            &nbsp&nbsp&nbsp
