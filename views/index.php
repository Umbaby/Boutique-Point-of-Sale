  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_house"></i> Home</h3>
            <ol class="breadcrumb">
              <li><i class="icon_house"></i><a href="index.php">Home</a></li>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <h1>  <span class="logo">SHOE </span> <span class="lite2">GLAMOUR</span> </h1>
              </div>
            </section>
          </div>
        </div>
