    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
			<li><i class="fa fa-uers"></i><a href="view_accounts.php">Accounts</a></li>
			<li><a href="update_accounts.php"> <i class="fa fa-plus"></i> Change Account Details</a></li>        
		  </ol>
		</div>
	  </div>
...
?>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
                    <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                    <tr>
                                        <td><input type="text" size="15" name="id" value="<?php echo $row['0']; ?>" readonly/></td>
                                        <td><input type="text" name="name" size="15" value="<?php echo $row['1']; ?>" required/></td>
                                        <td><input type="number" name="age" min="18" max="65" value="<?php echo $row['2']; ?>" required/></td>
                                        <td><input type="number" name="mobile" value="<?php echo $row['3']; ?>" required/></td>
                                        ...
                                        <td><input type="text" name="username" size="10" value="<?php echo $row['5']; ?>" required/></td>
                                        <td><select id="account_type" name="account_type" required>
                                                <?php if($row['6']=="admin"){ ?>
                                                    <option id="admin" name="admin">Admin</option>
                                                    <option id="user" name="user">Staff</option>
                                                <?php } else { ?>
                                                    <option id="user" name="user">Staff</option>
                                                    <option id="admin" name="admin">Admin</option>
                                                <?php } ?>
                                            </select></td>
                                        <td><input type="password" name="password" size="12" minlength="8" value="<?php echo $row['7']; ?>" required/></td>
                                    </tr>
                            </tbody>
                        </table>
